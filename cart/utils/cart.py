...
class Cart():
    ...
    def __iter__(self):
        ...
        for product in products:
            ...
            cart[id]['url'] = reverse('product-info', args=[product.slug])
            cart[id]['discount'] = product.discount if product.discount else 0
    ...
    def apply_coupon(self, coupon_code):
        try:
            ...
            if coupon.discount is not None and coupon.discount >= 0:
                self.coupon = coupon.discount  # Store only the discount value
